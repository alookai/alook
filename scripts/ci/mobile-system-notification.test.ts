...
describe("mobile system notification contract", () => {
  ...
  it("locks Android FCM delivery, durable state, and credential-free builds", () => {
    ...
    expect(androidRoute).toContain("MOBILE_PUSH_NOTIFICATION_AUTO_CANCEL = false")
    expect(androidService).toContain("setAutoCancel(MOBILE_PUSH_NOTIFICATION_AUTO_CANCEL)")
