  ...
  it("publishes only the documented ESM and declaration surface", () => {
    ...
    try {
      ...
      expect(files).toEqual([
        ...
        "dist/index.js",
        "dist/index.js.map",
        "dist/logicalChildProcessSession.d.ts",
        "dist/logicalChildProcessSession.d.ts.map",
        "dist/logicalChildProcessSession.js",
        "dist/logicalChildProcessSession.js.map",
        "dist/logicalInProcessSession.d.ts",
        "dist/logicalInProcessSession.d.ts.map",
        "dist/logicalInProcessSession.js",
        "dist/logicalInProcessSession.js.map",
        "dist/registry.d.ts",
        ...
        "dist/turnCoordinator.d.ts",
        "dist/turnCoordinator.d.ts.map",
        "dist/turnCoordinator.js",
        "dist/turnCoordinator.js.map",
        "package.json",
      ]);
