...
describe("DM page loading ownership", () => {
  it("keeps full-frame and message-body ownership separate", () => {
    ...
    expect(source).toContain("<ComposerOverlayShell\n")
    ...
    expect(source).toContain("composerOverlap={dmBlocked ? 0 : composerOverlap}")
    expect(source).toContain("onOverlapChange={setComposerOverlap}")
