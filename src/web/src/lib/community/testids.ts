...
export const tid = {
  ...
  messageHeaderLeadingLoading: "community-message-header-leading-loading",
  ...
  analyticsConsentAvatarCluster: "analytics-consent-avatar-cluster",
  accountDeletionOpen: "community-account-deletion-open",
  accountDeletionFlow: "community-account-deletion-flow",
  accountDeletionSendCode: "community-account-deletion-send-code",
  accountDeletionOtp: "community-account-deletion-otp",
  accountDeletionSubmit: "community-account-deletion-submit",
  accountDeletionComplete: "community-account-deletion-complete",
  ...
  botAuditPreviewEarlier: "community-bot-audit-preview-earlier",
  botAuditPreviewScroll: "community-bot-audit-preview-scroll",
  botAuditPreviewBottom: "community-bot-audit-preview-bottom",
  botActivityModal: "bot-activity-modal",
  botAuditPreviewRow: (id: string) => `community-bot-audit-preview-row-${id}`,
  botMarkSticker: "community-bot-mark-sticker",
  botMarkStickerRow: (id: string) => `community-bot-mark-sticker-row-${id}`,
  botMarkStickerOverflow: "community-bot-mark-sticker-overflow",
  botMarkStickerStop: "community-bot-mark-sticker-stop",
  ...
  onboardingHarnessDialog: "community-onboarding-harness-dialog",
  onboardingHarnessOption: (runtime: string) => `community-onboarding-harness-${runtime}`,
  onboardingMachineDialog: "community-onboarding-machine-dialog",
  onboardingIdentityDialog: "community-onboarding-identity-dialog",
  onboardingIdentityOption: (identity: string) => `community-onboarding-identity-${identity}`,
  onboardingInitializeStatus: "community-onboarding-initialize-status",
  onboardingInitializeRetry: "community-onboarding-initialize-retry",
  onboardingStart: "community-onboarding-start",
  ...
  daemonUpdateBadge: "daemon-update-badge",
  landingHeaderContainer: "landing-header-container",
  ...
  myBotsPlanSummary: "my-bots-plan-summary",
  myBotsBilling: "my-bots-billing",
  billingSheet: "billing-sheet",
  billingRefresh: "billing-refresh",
  billingPortal: "billing-portal",
  billingCancelChange: "billing-cancel-change",
  billingCheckout: "billing-checkout",
  billingChangePlan: "billing-change-plan",
  createBot: "create-bot",
  botActive: (botId: string) => `bot-active-${botId}`,
  ...
  pdfPreview: "community-pdf-preview",
  pdfPreviewStatus: "community-pdf-preview-status",
  pdfPreviewPage: (pageNumber: number) => `community-pdf-preview-page-${pageNumber}`,
  ...
  inboxFriendRequest: (id: string) => `community-inbox-friend-request-${id}`,
  inboxFriendRequestOpen: (id: string) => `community-inbox-friend-request-open-${id}`,
  inboxFriendRequestAccept: (id: string) => `community-inbox-friend-request-accept-${id}`,
  inboxFriendRequestReject: (id: string) => `community-inbox-friend-request-reject-${id}`,
  friendsShortcutBadge: "community-friends-shortcut-badge",
  friendsNewBadge: "community-friends-new-badge",
