...
describe("community QA selectors", () => {
  ...
  it("exposes attachment preview selectors from one canonical map", () => {
    ...
    expect(tid.pdfPreview).toBe("community-pdf-preview")
    expect(tid.pdfPreviewStatus).toBe("community-pdf-preview-status")
    expect(tid.pdfPreviewPage(2)).toBe("community-pdf-preview-page-2")
