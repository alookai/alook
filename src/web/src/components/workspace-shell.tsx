...
export function WorkspaceShell({ children }: { children: ReactNode }) {
    ...
    return (
      <SidebarTriggerContext.Provider value={() => setSidebarOpen(true)}>
        <AgentChatSheetProvider>
          <div ref={shellRef} className="flex flex-col h-dvh overflow-hidden relative" data-workspace-shell>
            <GradientBackground />
  ...
  return (
    <AgentChatSheetProvider>
      <div ref={shellRef} className="flex h-dvh overflow-hidden relative" data-workspace-shell>
        <GradientBackground />
        <AppSidebar />
