...
import { NOTIF_LEVELS, USE_SERVER_DEFAULT, type NotifLevel } from "@alook/shared/constants/community"
...
// A channel can inherit the server default (UI-only sentinel) or pin one of
// the three real levels. Derived from the shared single-source so the strings
// can't drift.
...
// The "Nothing" display string — the muted state's stored level — pulled from
// the single source so the mute-toggle comparison can't drift.
