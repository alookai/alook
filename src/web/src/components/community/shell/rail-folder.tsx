        ...
        <ContextMenu>
          ...
          >
            ...
            <button
              ...
              onClick={onToggle}
              className="group/folder grid size-11 cursor-pointer touch-none place-items-center focus-visible:ring-2 focus-visible:ring-ring focus-visible:outline-none active:cursor-grabbing"
            >
              <span className={[
