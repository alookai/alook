export const metadata = {
  ...
  author: "Alook Team",
  excerpt:
    "AI agent coordination keeps multiple agents aligned on roles, handoffs, retries, and shared state. Orchestration is the system layer that makes that coordination reliable.",
