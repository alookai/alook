...
![Agent organization structure](./images/seo-team.png)
...
![Chat interface showing task input](./images/chat-interface.jpg)
...
![Email activity feed](./images/email-inbox.png)
