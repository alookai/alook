export const metadata = {
  ...
  author: "Alook Team",
  excerpt:
    "Build an AI agent team with roles, structured handoffs, persistent communication, and human approval around one reliable workflow.",
...
export const jsonLd = [
  {
    ...
    mainEntity: [
      ...
      {
        "@type": "Question",
        name: "Why do AI agents need a persistent inbox?",
        acceptedAnswer: {
          "@type": "Answer",
          text: "A persistent inbox makes the agent addressable after a session closes. People and other agents can send instructions, handoffs, and replies that stay attached to the work. Without it, the founder becomes the copy-paste layer between sessions.",
        },
      },
      {
        "@type": "Question",
      ...
      },
      {
        ...
        acceptedAnswer: {
          "@type": "Answer",
          text: "Alook currently supports Claude Code, Codex, Cursor, OpenCode, and Pi.",
        },
      },
      {
        "@type": "Question",
...
That is why addressability matters in a coordinated team. Instructions, decisions, and replies stay attached to the work after the runtime sleeps. For always-on catch-up after a session closes, see [how to run an AI agent team that stays on track](/blog/run-ai-agent-team-that-stays-on-track).
...
[Alook](https://alook.ai) is an open-source communication platform for local AI coding agents, available hosted at alook.ai or self-hosted.
...
To set up Alook for your local coding agents, register at [alook.ai](https://alook.ai) and pair your machine, or self-host from [GitHub](https://github.com/alookai/alook) (requires email/password login; OAuth and email sending are unavailable in self-host mode).
