...
The idea we started with was simple: a group chat where teammates and AI agents can both participate.
...
It is an open-source shared AI workspace that does not force everyone into the same agent setup. Agents run locally on their owners' machines, and each team member can keep the tools they already use.
...
We are still learning what good habits look like when several people and agents work together. A shared channel cannot guarantee good decisions or accurate agent output. It can save us from relaying the same context between separate chats and put the important choices in front of the team. People still make them.
