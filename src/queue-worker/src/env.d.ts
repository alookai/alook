/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=wrangler.toml --env-file=.dev.vars.example src/env.d.ts` (hash: 4cd8675ada7d5a9c7c658fd7004e23c4)
// Runtime types generated with workerd@1.20260916.1 2026-09-07 nodejs_compat
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "FCM_ANDROID_APP_ID" | "ENCRYPTION_KEY" | "APNS_TEAM_ID" | "APNS_KEY_ID" | "APNS_PRIVATE_KEY" | "APNS_TOPIC" | "FCM_PROJECT_ID" | "FCM_CLIENT_EMAIL" | "FCM_PRIVATE_KEY">> {}
}
